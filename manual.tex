...
\texttt{-{}-lang} & from file & Output language: \texttt{rust}, \texttt{c}, or \texttt{python}. If omitted, reads the \texttt{lang:} key from the SMB file (defaults to \texttt{rust} if absent). The \texttt{lang:} key may be a list, in which case code is generated for all listed languages. \\
...
lang: rust              # Target language (rust, c, or python)
